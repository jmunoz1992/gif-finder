 ...
 * THUNK CREATORS
 */
export const getGifsThunk = () => async dispatch => {
  try {
    const res = await Axios.get('http://api.giphy.com/v1/gifs/search?q=kittens&api_key=3Scw7m82zJbfSn8aipUENSrHBRCTd2Ta');
